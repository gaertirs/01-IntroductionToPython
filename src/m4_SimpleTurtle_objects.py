...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         Aaron Wilkin, their colleagues, and Bobby Gaertig.
"""
###############################################################################
#
# DONE: 1.
...
natasha.speed = 9  # Bigger means faster, max is usually about 10

natasha.backward(50)
natasha.left(90)
natasha.forward(300)

natasha.speed = 3  # Now slower
...
bobby.pen = rg.Pen('green', 10)
bobby.speed = 2
bobby.draw_circle(150)
